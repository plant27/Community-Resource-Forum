          ...
          eventContent={(eventInfo) => (
            ...
            >
              <div 
                ...
                className="flex cursor-pointer flex-col gap-0.5 rounded-sm border-l-[3px] border-l-sky-500 bg-white/95 py-1 px-1.5 shadow-sm transition-all hover:translate-y-[-1px] hover:shadow-md"
              >
                <div className="line-clamp-1 text-sm font-medium text-gray-900">{eventInfo.event.title}</div>
